...
Release 3.6 keeps aggregate measurement outside the evidence ledger.
...
3. `evals/sdlc/cases.json` checks agent behavior under realistic pressure.

Static checks are defense in depth. They do not replace independent review or
