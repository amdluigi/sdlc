---
name: sdlc-operational-readiness
description: 'Use when production data, public contracts, runtime or deployment configuration, infrastructure, background processing, or rollout are affected.'
license: MIT
metadata:
  ...
  sdlc-modules: "operational-readiness"
---
