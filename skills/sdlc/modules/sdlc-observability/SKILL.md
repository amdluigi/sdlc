...
description: "Use when a change adds, removes, or modifies logs, metrics, traces, dashboards, or alerts; introduces or changes a service, queue, scheduled-job, or other asynchronous production boundary; or has an accepted requirement for new diagnostic or operational signals."
metadata:
  sdlc-provider-schema: "1"
  sdlc-compatible: ">=1.0.0 <2.0.0"
  sdlc-modules: "observability"
---
