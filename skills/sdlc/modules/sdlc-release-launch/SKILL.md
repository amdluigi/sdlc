---
name: sdlc-release-launch
description: "Use when a completed change is being published, deployed, released, launched, rolled out, tagged, or otherwise made available to an external audience."
metadata:
  sdlc-provider-schema: "1"
  sdlc-compatible: ">=1.0.0 <2.0.0"
  sdlc-modules: "release-launch"
---
